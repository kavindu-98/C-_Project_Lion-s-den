...
{
    public partial class ad_forgot : Form
    {
        ...
        {
            admin_login f9 = new admin_login();
            f9.Show();
            this.Hide();
        }
        ...
        private void guna2TextBox3_TextChanged(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand Comm1 = new SqlCommand("select question  from user_con WHERE id = '1' " , con);
        ...
        private void ad_sign_btn_Click(object sender, EventArgs e)
        {
            ...
            if (iscorrect == true)
            {
                try
                {
                    ...
                    admin_login us1 = new admin_login();
                    us1.Show();
                    this.Close();
                }
                catch (SqlException)
